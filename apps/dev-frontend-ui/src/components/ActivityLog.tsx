...
const ActivityLog = () => {
    ...
    return (
        <div className="bg-black/40 backdrop-blur-xl border border-white/10 rounded-2xl p-6 shadow-[0_0_30px_rgba(0,0,0,0.5)] transition-all hover:border-cyan-500/30 flex flex-col h-full group relative overflow-hidden">
            ...
            <div className="flex justify-between items-center mb-6 cursor-pointer" onClick={() => setIsCollapsed(!isCollapsed)}>
                <h2 className="text-lg font-bold text-white flex items-center gap-2">
                    <Activity className={`w-5 h-5 text-purple-400 transition-transform ${isCollapsed ? '-rotate-90' : ''}`} /> Activity Log
                </h2>
